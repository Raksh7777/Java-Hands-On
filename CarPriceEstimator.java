...
public class CarPriceEstimator {
	...
	public double getSalePrice(String makeAndModel, int yearManufactured, double milesDriven,
		...
		if (additionalMiles > 1_000 && additionalMiles <= 10_000){
			salePrice -= 500;
		}
		...
		if (additionalMiles > 10_000 && additionalMiles <= 30_000){
			salePrice -= 1000;
		}
	...
	public static void main(String[] args) {
		...
		double salesPrice = carPriceEstimator.getSalePrice("ford ecosport", 2010, 60000.0, 2, true, false, true, false, false, true);
	}
}